...
namespace Microsoft.Liftr.Marketplace.Billing
{
    ...
    public interface IMarketplaceBillingService
    {
        ...
        Task<MeteredBillingRequestResponse> SendUsageEventAsync(UsageEventRequest marketplaceUsageEventRequest, CancellationToken cancellationToken = default);
        ...
        Task<MeteredBillingRequestResponse> SendBatchUsageEventAsync(BatchUsageEventRequest marketplaceBatchUsageEventRequest, CancellationToken cancellationToken = default);
    }
}
