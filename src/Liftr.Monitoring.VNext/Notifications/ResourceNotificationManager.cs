...
{
    public class ResourceNotificationManager : NotificationManagerBase
    {
        public ResourceNotificationManager(
        ...
        protected override async Task RestoreLiftrDiagnosticSettingsAsync(MonitoringRelationshipModel relationshipModel, ITimedOperation operation)
        {
            ...
            _logger.Information("Restoring the Liftr managed Resource Diagnostic Settings {diagnosticSettingsId}.");
            ...
            {
                _logger.Information("Resource Diagnostic Settings {diagnosticSettingsId} restored successfully.", relationshipModel.DiagnosticSettingsId);
            }
            else
            {
                _logger.Error("Failed at re-creating Resource Diagnostic Settings {diagnosticSettingsId}.", relationshipModel.DiagnosticSettingsId);
