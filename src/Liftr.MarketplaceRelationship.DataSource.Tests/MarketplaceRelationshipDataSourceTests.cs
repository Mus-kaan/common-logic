...
namespace Liftr.MarketplaceRelationship.DataSource.Test
{
    public sealed class MarketplaceRelationshipDataSourceTests : IDisposable
    {
            ...
            public async Task AddRetrieveRelationshipEntityAsync()
            {
                ...
                var entity = new MarketplaceRelationshipEntity(marketplaceSubscription, resourceId1, region1, tenantId1);
                ...
                // Can retrieve single entity.
                {
                    ...
                    Assert.Equal(region1, retrieved.RPRegion);
            ...
            public async Task RetrieveMultipleEntitiesAsync()
            {
                ...
                var entity = new MarketplaceRelationshipEntity(marketplaceSubscription, resourceId1, region1, tenantId1);
                var entity2 = new MarketplaceRelationshipEntity(marketplaceSubscription, resourceId2, region2, tenantId2);
                ...
                // Can retrieve multiple entities.
                {
                    ...
                    Assert.Equal(region1, retrieved.First().RPRegion);
