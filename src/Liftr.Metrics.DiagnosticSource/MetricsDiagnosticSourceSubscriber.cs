...
namespace Microsoft.Liftr.Metrics.DiagnosticSource
{
    ...
    /// </summary>
    internal sealed class MetricsDiagnosticSourceSubscriber : IObserver<DiagnosticListener>, IDisposable
    {
        private readonly IDisposable _listenerSubscription;
        private readonly MetricsDiagnosticSourceListener _listener;
        private IDisposable _eventSubscription;

        public MetricsDiagnosticSourceSubscriber(MetricsDiagnosticSourceListener listener)
        {
            _listener = listener;
            try
            {
