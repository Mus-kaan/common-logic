...
IMG_mdsd="genevamdsd:master_330"
IMG_mdm="genevamdm:master_51"
IMG_fluentd="genevafluentd_td-agent:master_156"
IMG_azsecpack="genevasecpackinstall:master_60"
IMG_kubegen="kube-gen:master_26"
IMG_kubectl="kubectl:master_23"
IMG_acskv="acskeyvaultagent:master_30"
